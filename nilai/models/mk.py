...
class mk(models.Model):  # inherit dari Model
    _name = 'nilai.mk'  # atribut dari class Model
    ...
    name = fields.Char('Name MK', size=64, required=True, index=True, readonly=True,
                       states={'draft': [('readonly', False)]})
    kode_mk = fields.Char('Kode MK', size=64, required=True, index=True, readonly=True,
                          states={'draft': [('readonly', False)]})
    sks = fields.Integer('SKS', default=0, readonly=False)
