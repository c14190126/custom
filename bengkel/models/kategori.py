...
class kategori(models.Model):  # inherit dari Model
    _name = 'bengkel.kategori'  # atribut dari class Model
    ...
    name = fields.Char('Kategori', size=64, required=True, index=True, readonly=True,
    ...
    def create(self, vals_list):
        seq = self.env['ir.sequence'].search([("code", "=", "bengkel.kategori")])
        if not seq:
